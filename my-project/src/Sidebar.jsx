...
function Sidebar() {
  ...
  const listStyle = "m-0 p-2 w-56 hover:border-white hover:border-2 hover:text-white"
  return (
    <div className='bg-[#674fa3] flex w-56  h-screen  text-sm font-medium  fixed'>
      <ul className='pl-2'>
        ...
        <NavLink className={navLinkStyle} to={"/transaction"}><li className={listStyle}><i className="pr-4 bi bi-bank2"></i> Transaction</li></NavLink>
        ...
        <NavLink className={navLinkStyle} to={"/vehicles_verification"}><li className={listStyle}><i className="pr-4 bi bi-person-vcard-fill"></i> Vehicle Verifications</li></NavLink>
